...
import 'package:bill_genie/admin-pages/farmer_cash_update.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class FarmerCashBook extends StatefulWidget {
  const FarmerCashBook({Key? key});

  @override
  _FarmerCashBookState createState() => _FarmerCashBookState();
}

class _FarmerCashBookState extends State<FarmerCashBook> {
  String searchText = "";
        ...
        return ListTile(
          ...
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    FarmerCashUpdate(phone: phone, balance: amount, name: name),
              ),
            );
          },
        );
