...
class CustomerCashUpdate extends StatefulWidget {
  final String phone;
  final double balance;
  final String name;

  const CustomerCashUpdate({
    Key? key,
    required this.phone,
  ...
  @override
  _CustomerCashUpdateState createState() => _CustomerCashUpdateState();
}

class _CustomerCashUpdateState extends State<CustomerCashUpdate> {
  String? date;
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const CustomerCashBook()),
            );
          },
          icon: const Icon(
            Icons.arrow_back,
