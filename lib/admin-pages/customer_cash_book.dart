...
import 'package:bill_genie/admin-pages/customer_cash_update.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class CustomerCashBook extends StatefulWidget {
  const CustomerCashBook({super.key});

  @override
  _CustomerCashBookState createState() => _CustomerCashBookState();
}

class _CustomerCashBookState extends State<CustomerCashBook> {
  String searchText = "";
        ...
        return ListTile(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => CustomerCashUpdate(
                    phone: phone, balance: amount, name: name),
              ),
            );
          },
        );
